...
const items: CardNavItem[] = [
  {
    ...
    links: [
      ...
      {
        label: "Stay Info & Rates",
        href: "#pricing",
        ariaLabel: "Cottage pricing",
      },
  ...
  },
  {
    ...
    links: [
      {
        label: "Visit Northumbria Travel Guide",
        ariaLabel: "Travel Guide",
        href: "https://www.visitnorthumberland.com/explore/things-to-do",
      },
      {
        label: "Northumbria Interactive map",
        ariaLabel: "Travel Guide",
        href: "https://www.visitnorthumberland.com/travel-tips/while-youre-here/tourist-information-centres?map",
      },
      {
        label: "Local favourites",
        href: "#local-favourites",
        ariaLabel: "Local favourites",
      },
      {
        label: "Experience",
        href: "#experience-heading",
        ariaLabel: "Northumberland experience",
      },
    ],
  },
  {
