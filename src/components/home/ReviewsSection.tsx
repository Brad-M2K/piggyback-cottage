    ...
    <section id="reviews" className="scroll-mt-32 space-y-10 py-16">
      <div className="text-center space-y-3">
        ...
        <p className="text-slate max-w-3xl mx-auto text-base leading-relaxed">
          A few highlights from recent guests who made Piggyback Cottage their
          home for a few days.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-5xl">
              ...
              <SwiperSlide key={review.name} className="!h-auto">
                <figure className="flex min-h-[25rem] flex-col rounded-3xl border border-muted-sage/20 bg-cream/70 p-6 shadow-sm backdrop-blur sm:min-h-[22rem] sm:p-8">
                  ...
                  <figcaption className="mt-auto pt-6 text-sm font-medium text-forest">
                    {review.name}
                    <span className="block text-slate/70 font-normal">
                      {review.stay}
                    </span>
                  </figcaption>
                </figure>
        ...
        {hasMultipleReviews ? (
          <div className="mt-6 flex items-center justify-center gap-4">
            ...
            <div
              className="flex min-w-20 justify-center gap-2"
      ...
      {expandedReview ? (
        ...
        >
          <article className="relative max-h-[85vh] w-full max-w-3xl overflow-y-auto rounded-3xl bg-cream p-6 shadow-2xl sm:p-8">
            <button
              type="button"
            ...
            <h3
              ...
              className="pr-12 text-2xl font-serif text-forest"
            >
              {expandedReview.name}
            </h3>
